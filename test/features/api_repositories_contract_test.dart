...
void main() {
  group('API repositories contract mapping', () {
    test('auth verifyOtp maps result envelope and request payload', () async {
      ...
      expect(call.path, ApiEndpoints.authOtpVerify);
      expect(call.data, <String, dynamic>{
        'phone': '+998901112233',
        'code': '1234',
      });
      expect(user.id, 'u-1');
      expect(user.subscriptionPlan, SubscriptionPlan.premium);
