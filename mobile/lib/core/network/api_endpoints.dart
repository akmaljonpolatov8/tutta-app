class ApiEndpoints {
  ...
  static String bookingConfirm(String bookingId) => '${bookingById(bookingId)}/confirm';

  static String bookingCancel(String bookingId) => '${bookingById(bookingId)}/cancel';

  // Legacy booking endpoints (to be removed after full booking migration)
  static String guestBookings(String guestUserId) => '$bookings/guest/$guestUserId';

  static String hostBookings(String hostUserId) => '$bookings/host/$hostUserId';

  static String bookingReject(String bookingId) => '${bookingById(bookingId)}/reject';

  static String bookingCancelByGuest(String bookingId) => '${bookingById(bookingId)}/cancel-by-guest';

  static String bookingComplete(String bookingId) => '${bookingById(bookingId)}/complete';

  static String bookingPaymentStatus(String bookingId) => '${bookingById(bookingId)}/payment-status';
